...
export type MenuPathsType = typeof appPaths[keyof typeof appPaths];

export type IMenuItem = {
  title: string;
  icon: ReactElement<SVGProps<SVGSVGElement>, React.FunctionComponent>;
  path: MenuPathsType;
...
export type ResponseType = {
  suggestions: Array<ResponseData>;
};

export type ResponseData = {
  value: string;
  unrestricted_value: string;
  data: ExtendedResponseData;
};

export type ExtendedResponseData = {
  postal_code?: any;
  country: string;
